...
use crate::{
    ...
    error::{Error, Result},
    state::{GlobalHandler, NewState, State, StateHandler, StateMachine, States},
    ...
    S: State<StateEvent>,
{
    ...
    pub fn with_defaults(mut self) -> Self {
        ...
        impl<S> GlobalHandler<S, StateEvent> for DefaultCallback {
    ...
    for<'event> R: EventReader<'event, Event = E>,
{
    ...
    pub fn with_boxed_global(mut self, callback: Box<dyn GlobalHandler<S, E>>) -> Self {
    ...
    ///
    /// use amethyst::prelude::{StateHandler, Application, GameDataBuilder};
    ...
    /// struct LoadingState;
    ///
    /// impl<E> StateHandler<State, E> for LoadingState {
        ...
        I: DataInit<GameData<'res, 'threadlocal>>,
    {
        ...
        impl<S, E> GlobalHandler<S, E> for UpdateState
        where
